...
* Installer package for Windows:
  ...
  [tp-note-1.7.1-x86_64.msi](https://blog.getreu.net/projects/tp-note/_downloads/wix/tp-note-1.7.1-x86_64.msi)
...
* Package compiled for Debian 10+ (Buster):
  ...
  [x86_64-unknown-linux-gnu/debian/tp-note_1.7.1_amd64.deb](https://blog.getreu.net/projects/tp-note/_downloads/x86_64-unknown-linux-gnu/debian/tp-note_1.7.1_amd64.deb)
