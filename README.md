...
* Binaries and packages (usually built from latest commit):
  ...
  - Package for Debian 10 Buster:
    ...
    [x86_64-unknown-linux-gnu/debian/tp-note_1.4.2_amd64.deb](https://blog.getreu.net/projects/tp-note/_downloads/x86_64-unknown-linux-gnu/debian/tp-note_1.4.2_amd64.deb)
