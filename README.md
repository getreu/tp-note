...
[![License](https://img.shields.io/badge/license-MIT%2FApache--2.0-blue.svg)](https://gitlab.com/getreu/tp-note)
...
2.  Download, compile and install _Tp-Note_:
    ...
    **Building on Windows and macOS**
    ...
    [^win]:
        When building for Windows or macOS, it does not make sense to exclude
